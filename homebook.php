...
<section class="hero">
  ...
  <p>Find books for your studies easily.</p>
</section>

<?php
if (isset($_GET['borrow']) && $_GET['borrow'] === 'success') {
  echo '<div class="message">Good! Book borrowed successfully!</div>';
}
?>
...
?>
  <div class="book-card">
    ...
    <?php if (!empty($row['cover_image'])): ?>
      <img src="<?= htmlspecialchars($row['cover_image']) ?>" alt="Book Cover">
    <?php else: ?>
